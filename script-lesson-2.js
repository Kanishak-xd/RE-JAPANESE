...
allOptionBoxes.forEach((optionBox) => {
    optionBox.addEventListener('click', () => {
        ...
        if (optionText.textContent == "A" && quesLetter.textContent == "ア") {
            correctAns(optionBox, optionText);
            setTimeout(()=>{
                revertBack(optionBox, optionText);
            }, 1000)
        } else if (optionText.textContent !== "A" && quesLetter.textContent == "ア") {
            incorrectAns(optionBox, optionText);
            setTimeout(()=>{
                revertBack(optionBox, optionText);
            }, 1000)
        } else if (optionText.textContent == "I" && quesLetter.textContent == "イ") {
            correctAns(optionBox, optionText);
            setTimeout(()=>{
                revertBack(optionBox, optionText);
            }, 1000)
        ...
        } else if (optionText.textContent == "U" && quesLetter.textContent == "ウ") {
            correctAns(optionBox, optionText);
            setTimeout(()=>{
                revertBack(optionBox, optionText);
            }, 1000)
        ...
        } else if (optionText.textContent == "E" && quesLetter.textContent == "エ") {
            correctAns(optionBox, optionText);
            setTimeout(()=>{
                revertBack(optionBox, optionText);
            }, 1000)
        ...
        } else if (optionText.textContent == "O" && quesLetter.textContent == "オ") {
            correctAns(optionBox, optionText);
            setTimeout(()=>{
                revertBack(optionBox, optionText);
            }, 1000)
        ...
        if (seikai == 1) {
            quesLetter.textContent = "ウ"
        } else if (seikai == 2) {
            quesLetter.textContent = "イ"
        } else if (seikai == 3) {
            quesLetter.textContent = "オ"
        } else if (seikai == 4) {
            quesLetter.textContent = "エ"
        }  else if (seikai == 5) {
            setTimeout(()=>{
